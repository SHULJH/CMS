...
<body>
    <form action="/CMS/index.php/Home/Tea/select_course" method="post">
    ...
    <table class="table">
        <caption>开课列表，点开进入详细选课信息</caption>
        <thead>
        <tr>
            <th>开课学期</th>
            <th>开课名称</th>
 ...
 for($i=0; $i<$count; $i++){ ?>
                <tr>
                     ...
                     <td><a href="<?php echo U('Tea/course_stu', array('m_xq'=>$result[$i]['xq'], 'm_kh'=>$result[$i]['kh'], 'm_km'=>$result[$i]['km']));?>">课程详细</a></td>
                 </tr>
            <?php
 } ?>
        </tbody>
